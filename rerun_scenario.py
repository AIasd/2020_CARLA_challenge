...
def rerun_simulation(pickle_filename, rerun_save_folder, ind):
    ...
    with open(pickle_filename, 'rb') as f_in:
        ...
        x = d['x']
        x = np.concatenate([x, np.array([port])])
...
if __name__ == '__main__':
    ...
    if data == 'bugs':
        folder = '/home/zhongzzy9/Documents/self-driving-car/2020_CARLA_challenge/bugs/False/nsga2/Town03/Scenario12/front/00/2020_08_11_02_22_01'
    elif data == 'non_bugs':
        folder = ''
